    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:robertomoraeszar@gmail.com' >
                    ...
                    <BoxTexts>
                        <LinkText>Enviar e-mail</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxContact target="blank"  href='https://api.whatsapp.com/send?phone=5511973874345' >
                    ...
                    <BoxTexts>
                        <LinkText>Chamar no whatsapp</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxCV href={"https://drive.google.com/file/d/1t_hYQ0-ODL-DBGqx8EjzQ2RTk00TnDk8/view?usp=sharing"} target="_blank">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <BoxTexts>
                        <LinkTextCV>Ver CV</LinkTextCV>
                    </BoxTexts>
                </BoxCV>

                <ContainerSocialMedias>
                    <SocialMedia target="blank"  href='https://www.linkedin.com/in/robertomoraeszarzur/'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank"  href='https://github.com/Rdemora2'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
