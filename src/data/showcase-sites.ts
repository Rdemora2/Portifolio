...
export const websiteExperiences = [
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
      "editorialExperience",
      "responsiveExperience",
  ...
  },
  {
    ...
    image: {
      src: "/images/sites/casa-brasa-experience.webp",
      width: 1410,
      height: 831,
      blurDataURL:
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
      "institutionalStrategy",
      "responsiveExperience",
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
      "editorialExperience",
      "responsiveExperience",
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
      "institutionalStrategy",
      "responsiveExperience",
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
    tagIds: [
      "institutionalStrategy",
      "responsiveExperience",
  ...
  },
  {
    ...
    image: {
      ...
      height: 831,
      blurDataURL:
        "data:image/jpeg;base64,",
    },
