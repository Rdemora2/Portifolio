...
| Demonstrações disponíveis | 9/9 respostas HTTP 200 na auditoria original; Carla Moraes foi restaurada e SEN Omakase foi integrado posteriormente, ambos com as URLs validadas em HTTP 200, totalizando 11 demonstrações publicadas. | [sites da auditoria](evidence/available-websites.json) |
