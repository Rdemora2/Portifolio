...
type MetricsStyle = CSSProperties & {
  "--metric-columns": number
}

function getHeroWordStyle(index: number): HeroWordStyle {
  if (index === 0) {
    return { "--hero-word-x": "-1.2vw", "--hero-word-y": "0rem" }
  }

  return {
    "--hero-word-x": `${Math.min(index * 2.6, 6.5)}vw`,
    "--hero-word-y": index % 2 === 0 ? "0.35rem" : "-0.25rem",
  }
}
  ...
  return (
    ...
    >
      ...
      <article aria-labelledby="article-title">
        ...
        >
          <div className={styles.telemetryInner}>
            ...
            <dl
              ...
              style={
                {
                  "--metric-columns": Math.min(
                    Math.max(article.metrics.length, 1),
                    4,
                  ),
                } as MetricsStyle
              }
            ...
            <div className={styles.storyContent}>
              <section className={styles.architecture}>
                ...
                <div className={styles.architectureHeading}>
                  ...
                  <h2>{article.architectureTitle}</h2>
        ...
        <section className={styles.ctaSection} data-article-cta>
